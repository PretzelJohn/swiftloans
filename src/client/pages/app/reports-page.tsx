...
const defaultData: string[][] = [
  ...
  ['Pipeline Report - September 16, 2024', 'Pipeline', '09/16/2024'],
  ['Sales Report - September 16, 2024', 'Sales', '09/16/2024'],
  ['Task Report - September 16, 2024', 'Task', '09/16/2024'],
  ['Leads Report - September 15, 2024', 'Leads', '09/15/2024'],
  ['Pipeline Report - September 15, 2024', 'Pipeline', '09/15/2024'],
  ['Sales Report - September 15, 2024', 'Sales', '09/15/2024'],
  ['Task Report - September 15, 2024', 'Task', '09/15/2024'],
];
  ...
  return (
    <>
      ...
      <View columns={columns} data={defaultData}>
        <Popover onClickOutside={() => {}} content={<ReportModal />}>
          <Button>
