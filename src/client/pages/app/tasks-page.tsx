...
const defaultData: string[][] = [
  ['Connect your Google Account', '-', '-', 'In Progress', '09/05/2024'],
  ['Follow up with Susan B.', '-', '-', 'In Progress', '09/16/2024'],
  ['Call new lead: Lucas Hussey', '-', '-', 'Not Started', '09/19/2024'],
  ['Call new lead: Lukas Haffer', '-', '-', 'Done', '09/20/2024'],
  ['Submit documents for Lukas Haffer', '-', '-', 'Not Started', '09/20/2024'],
];
  ...
  return (
    <>
      ...
      <View columns={columns} data={defaultData}>
        <Popover onClickOutside={() => {}} content={<TaskModal />}>
          <Button>
